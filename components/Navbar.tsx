  ...
  return (
    <header className="z-[999] relative">
      ...
      <motion.nav
        initial={{ y: -100, x: "-50%", opacity: 0 }}
        animate={{ y: 0, x: "-50%", opacity: 1 }}
        className="flex sm:top-[1.6rem] top-[0.75rem] justify-center items-center fixed  
    left-1/2 h-12 -translate-x-1/2 py-2  sm:h-[initial] sm:py-0"
      >
        <ul
          className="flex w-[22rem] flex-wrap items-center
       justify-center gap-y-1 text-[0.8rem] font-3xl sm:text-[1rem]
